...
[Compressed](https://link.us1.storjshare.io/raw/jwdx5meiauuirqdr3wojhiboy6yq/pocket-blockchain/pocket-network-data-1823-RC-0.7.0.1.tar.gz)

[Tar](https://link.us1.storjshare.io/raw/jv5yilqsnlkmfbbsv2svehcju5ha/pocket-blockchain/pocket-network-data-1823-RC-0.7.0.1.tar)
...
wget -qO- https://link.us1.storjshare.io/raw/jv5yilqsnlkmfbbsv2svehcju5ha/pocket-blockchain/pocket-network-data-1823-RC-0.7.0.1.tar | tar xvf -
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-blockchain/pocket-network-data-1823-RC-0.7.0.1.tar ./pocket.tar --parallelism 5
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-blockchain/pocket-network-data-1823-RC-0.7.0.1.tar.gz ./pocket.tar.gz --parallelism 5
...
wget -O pocket.tar.gz https://link.us1.storjshare.io/raw/jwdx5meiauuirqdr3wojhiboy6yq/pocket-blockchain/pocket-network-data-1823-RC-0.7.0.1.tar.gz
...
wget -O pocket.tar https://link.us1.storjshare.io/raw/jv5yilqsnlkmfbbsv2svehcju5ha/pocket-blockchain/pocket-network-data-1823-RC-0.7.0.1.tar
...
time rclone copy --progress --s3-upload-concurrency 32 --s3-chunk-size 256M  downloader:pocket-blockchain/pocket-network-data-1823-RC-0.7.0.1.tar ./
