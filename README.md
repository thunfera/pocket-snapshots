...
[Compressed](https://link.us1.storjshare.io/raw/jucu4gnyy6ubvpdj4aoa6tiuti3a/pocket-blockchains/pocket-network-data-1328-RC-0.7.0.1.tar.gz)

[Tar](https://link.us1.storjshare.io/raw/jw6vhcrzbtxmrq2ziu2qpmimizla/pocket-blockchains/pocket-network-data-1328-RC-0.7.0.1.tar)
...
wget -qO- https://link.us1.storjshare.io/raw/jw6vhcrzbtxmrq2ziu2qpmimizla/pocket-blockchains/pocket-network-data-1328-RC-0.7.0.1.tar | tar xvf -
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-blockchains/pocket-network-data-1328-RC-0.7.0.1.tar ./pocket.tar --parallelism 5
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-blockchains/pocket-network-data-1328-RC-0.7.0.1.tar.gz ./pocket.tar.gz --parallelism 5
...
wget -O pocket.tar.gz https://link.us1.storjshare.io/raw/jucu4gnyy6ubvpdj4aoa6tiuti3a/pocket-blockchains/pocket-network-data-1328-RC-0.7.0.1.tar.gz
...
wget -O pocket.tar https://link.us1.storjshare.io/raw/jw6vhcrzbtxmrq2ziu2qpmimizla/pocket-blockchains/pocket-network-data-1328-RC-0.7.0.1.tar
...
time rclone copy --progress --s3-upload-concurrency 32 --s3-chunk-size 256M  downloader:pocket-blockchains/pocket-network-data-1328-RC-0.7.0.1.tar ./
